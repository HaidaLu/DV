...
pub fn h_eval(h_key: &[u8], digest: &mut [u8]) -> [u8; 32] {
...
// read hash digest and consume hasher
 let result = hasher.result(&mut digest);
}
*/
...
//---hmac- sha1::Sha1---;
extern crate sha1;
pub const SHA1_DIGEST_BYTES: usize = 32;
const SHA1_KEY_BYTES: usize = 64;

// hmac-sha1 algorithm
pub fn h_eval(key: &[u8], message: &[u8]) -> [u8; 20] {
